...
val get_conclusion : Constrexpr.constr_expr -> Constrexpr.constr_expr option
val is_constrexpr_c_app_named : Constrexpr.constr_expr -> string -> bool

val replace_fun_name_in_constrexpr :
  string -> string -> Constrexpr.constr_expr -> Constrexpr.constr_expr
